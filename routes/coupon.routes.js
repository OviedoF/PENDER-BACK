...
router.get('/service/:serviceId/active', CouponController.getActive) // Get active coupons
router.get('/service/:serviceId/scheduled', CouponController.getScheduled) // Get scheduled coupons
